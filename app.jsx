...
function Header({ liveOn, setLiveOn, lastUpdate, onRefresh, refreshing, status, onOpenSettings, countdown }) {
  const statusLabel = {
    mock: "Mock",
    loading: "Carregando…",
    connected: "Conectado",
      ...
      <div className="brand">
        <div className="brand-mark">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            <rect x="2" y="2" width="9" height="9" rx="2" fill="var(--accent-cold)" />
            <rect x="13" y="2" width="9" height="9" rx="2" fill="var(--accent-warm)" />
            <rect x="2" y="13" width="9" height="9" rx="2" fill="var(--accent-success)" />
            <rect x="13" y="13" width="9" height="9" rx="2" fill="var(--accent-hot)" />
          </svg>
        </div>
        <div>
          <div className="brand-name">CPEE Dashboard</div>
          <div className="brand-sub">Meta Ads · 3 contas · piloto auto</div>
        </div>
      </div>
